...
CREATE TABLE `biller_list` (
  ...
  `ref` text NOT NULL,
  `sha1_password` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `biller_list` (`billerID`, `biller_bill_name`, `biller_name`, `ref`,`sha1_password`) VALUES
(0, 'spotify_bill', 'Spotify', 'https://www.freepnglogos.com/uploads/spotify-logo-png/spotify-download-logo-30.png','a9993e364706816aba3e25717850c26c9cd0d89d'),
(1, 'discord_nitro_bill', 'Discord', 'https://www.freepnglogos.com/uploads/discord-logo-png/discord-logo-logodownload-download-logotipos-1.png','a9993e364706816aba3e25717850c26c9cd0d89d'),
(2, 'ph_premium_bill', 'PhilHealth', 'https://www.philhealth.gov.ph/news/2019/images/phic_logov.jpg','a9993e364706816aba3e25717850c26c9cd0d89d'),
(3, 'netflix_bill', 'Netflix', 'https://www.freepnglogos.com/uploads/netflix-logo-circle-png-5.png','a9993e364706816aba3e25717850c26c9cd0d89d'),
(4, 'yt_premium_bill', 'Youtube', 'https://assets.turbologo.com/blog/en/2019/10/19084944/youtube-logo-illustration.jpg','a9993e364706816aba3e25717850c26c9cd0d89d');